...
const GET_CATEGORY_RESULTS = gql`
  query GET_DATA(
    $first: Int
    $last: Int
    $after: String
...
const CategoryPostsList = () => {
  ...
  const { data, loading, fetchMore } = useQuery(GET_CATEGORY_RESULTS, {
    variables,
  })
  let selectedCategory
  if (data) {
    selectedCategory = data.categories.nodes.find(i => i.slug === category)
  }
  return loading ? (
    <LoadingScreen />
  ) : (
